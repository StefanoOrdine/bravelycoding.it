...
var scrollEvent ={
 	init: function(){
 		$('#scroll-top').on('click.scrollTop', scrollEvent.scrollUp);
 	},
				...
				audio.el.each( function(){
					...
					if( $().jPlayer ){
						$("#jquery-jplayer-audio-"+post_id).jPlayer({
							...
							swfPath: "/vendor/flatsum/assets/js",
...
//
// 	var _scroller = this;
// 	_scroller.cursorColor = $('html').data('cursor');
//
// 	var nice = $('html').niceScroll({
//         cursorcolor: "#"+_scroller.cursorColor || '#14ddb3',
//         railpadding: {
//             top: 0,
//             right: 5,
//             left: 5,
...
jQuery(document).ready( function(){
	...
	var body            = $('body'),
		...
		isFirefox       = /Firefox/i.test(userAgent); // Check if is FireFox
	...
	// 	//disable nicescroll plugin on windows phones
	// }else{
	// 	niceScrollInit.init();
	// }
